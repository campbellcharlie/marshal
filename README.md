...
- **Hot-add / remove.** The primary watches `marshal.config.json`; edit it and a backend spawns or stops
...
| `singleton-probe.mjs` | **singleton** — 2 marshals → 1 backend fleet; the proxy serves via the primary |
